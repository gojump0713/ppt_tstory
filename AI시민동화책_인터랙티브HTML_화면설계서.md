...
- 빵 표지에 문학 작품 이미지와 책갈피를 넣었더니 대박이 났습니다.
...
# PART Ⅱ — AI 동화 제작 서비스의 독서 활성화 방안 (Slide 19~26)
...
## Slide 20 — 대체가 아니라 확장입니다
- 좌 `대체하지 않습니다` / 중앙 `그리고` / 우 `확장합니다` 2단 카드
- 하단 `네 개의 흐름` 4개 타일 (→ 로 연결)

## Slide 21 — ① 시작하게 한다 — 독서의 진입장벽을 낮춥니다 (2×2 카드)
관심사 맞춤 이야기 · 연령·수준별 콘텐츠 · 음성 낭독 · 다국어 동화책 (각 요약 1줄 + 근거 2개, 클릭 없이 모두 노출)

## Slide 22 — ② 읽기를 만들기로 바꿉니다 (순환)
