...
### 거버닝 메시지
도서관이 가진 장서·사서·공간의 강점에 AI 창작 도구를 연결하면 시민은 독서의 수혜자를 넘어 자신의 이야기를 만드는 창작자가 됩니다. 책과 멀어진 시민에게 다시 도서관을 찾고 책을 펼칠 이유를 만드는 것이 제안의 출발점입니다.
...
### 제목
**문학을 만나는 입구는 이미 일상으로 넓어졌습니다**

### 거버닝 메시지
문학빵 사례는 ‘문학을 고르고, 모으고, 나누는 경험’ 자체가 관심의 입구가 될 수 있음을 보여줍니다. 판매량이 독서 증가를 뜻하는 것은 아니지만, 도서관도 시민이 이야기에 먼저 참여하게 만든 뒤 독서로 이어지는 새로운 입구를 설계할 수 있습니다.
...
### 거버닝 메시지
‘모두의 도서관’, ‘비독자의 독자 전환’, ‘AI 시대의 사유와 독서’는 서로 다른 정책처럼 보이지만 방향은 같습니다. 시민이 도서관에서 AI로 직접 창작하고 그 경험을 다시 독서로 연결하면 세 정책을 하나의 체감 서비스로 구현할 수 있습니다.
...
### 거버닝 메시지
디지털 포용, AI 활용 교육, 생애주기별 독서, 비독자 전환, 신뢰 기반 AI는 선언에 그쳐서는 시민이 체감하기 어렵습니다. 이 플랫폼은 정책 요구를 실제 도서관 프로그램의 기능과 운영 방식으로 1:1 연결합니다.
...
### 거버닝 메시지
장서·사서·공간은 이미 공공도서관의 강점입니다. 문제는 시민을 수동적 참여자에서 능동적 창작자로 바꾸고, AI를 안전하고 반복 가능한 프로그램으로 운영할 표준 연결 장치가 부족하다는 점입니다.
...
### 본문 화면 문구
Q1 **왜 정부가?**  
`비용·기기·역량·연령에 따른 배제를 줄이고 안전한 접근을 보장`

Q2 **왜 도서관이?**  
`아동부터 은퇴자까지 전 생애가 자발적으로 참여하는 공공문화 공간`
