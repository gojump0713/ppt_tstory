...
AI시민동화책_인터랙티브HTML_작업지시서_PRD.md   17장 구조·수치 무결성·UX 원칙
AI시민동화책_인터랙티브HTML_화면설계서.md       장표별 제목·화면 문구·레이아웃 (18~24장 PART Ⅱ 포함)
reading-activation-16x9.html                     PART Ⅱ(18~24장) 원본 문서 · 독서 활성화 방안
운영가이드.pptx · 운영가이드_PRD.md               PART Ⅲ(25~31장) 원본 · 운영 가이드·가격
...
| `B` | 배경 미디어 강조 토글 |
| `R` | 장표 다시 재생 |
| `D` / `Enter`(마지막 장) / 17·24장 DEMO 버튼 | 실제 서비스 시연 (`Backspace`·`Esc` 로 시연을 연 장표로 복귀) |
